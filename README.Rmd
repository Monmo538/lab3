...
In this R package we will implement two famous algorithms, the Euclidian algorithm to find the greatest common divisor of two integers and Dijkstra’s algorithm which is calculating the shortest path in a graph.
